...
namespace OLT.Extensions.EPPlus.Tests
{
    public class TestCase1
    {
        ...
        public void TestCase()
        {
            ...
            // Arrange
            //-----------------------------------------------------------------------------------------------------------
            var excelPackage1 = new ExcelPackage(typeof(TestBase).GetTypeInfo().Assembly.GetManifestResourceStream("OLT.Extensions.EPPlus.Tests.Resources.testcase1.xlsx"));
        ...
        [Fact(DisplayName = "https://github.com/eraydin/OLT.Extensions.EPPlus/issues/23")]
        public void Worksheet_CreatedBy_ToExcelPackage_ShouldBeParseable()
        {
            ...
            //throws OLT.Extensions.EPPlus.Exceptions.ExcelValidationException : 'DateColumn' column could not found on the worksheet.
